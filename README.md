# pi-pico-ss-oled
Simple OLED library for Pi Pico SDK

pi pico extension based on the work in https://github.com/bitbank2/ss_oled

## getting the library and compiling

do a <code>git clone https://github.com/martinkooij/pi-pico-ss-oled</code>
